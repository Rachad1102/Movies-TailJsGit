...
//affichage des films
//function pour afficher les films suivant chaque catégorie
...
function showMovies(moviesId){
  for (let i = 0; i < movies.length; i++) {
    ...
    if (movie.category === moviesId) {
      ...
      movieCard.className = "rounded lexend bg-slate-500 h-fit mt-4 w-full p-2 hover:scale-105 transition ease-out duration-300";
      movieCard.innerHTML = `
      <div class="h-60">
